...
<html>
    <body>
    <center><form action="edit_package3.jsp">
            <h2>Edit Tour/Package</h2><hr>
        <br><br><%mm.Conn1 c1=new mm.Conn1();
        String pid=request.getParameter("pid");
        ResultSet rs=c1.executeQuery("select * from package where package_no='"+pid+"'");
        if(rs.next()){
        %>
        <table><tr><th>Package Id</th><td><input type="text" value="<%=rs.getString("package_no")%>" name="pid" readonly="readonly"></td></tr>
            <tr><th>Package Name</th><td><input type="text" value="<%=rs.getString("package_name")%>" name="pname"></td></tr>
            <tr><th>Package Price(per person)</th><td><input type="text" value="<%=rs.getString("price")%>" name="price"></td></tr> 
            <tr><td colspan="2"><input type="submit" value="Change Details" ><%}%></form>  </center>  
    </body>
</html>
        </div>
          </div>
