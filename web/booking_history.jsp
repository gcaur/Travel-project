...
<html>
    ...
    <center><h2>My Booking History</h2></center><hr>
    <center><table cellspacing="10" cellpadding='10'><tr><th>To</th><th>Package Name</th><th>Duration</th><th>Total Person</th><th>Price(per person)</th><th>Total Price</th><th>Status</th></tr>
        <% String uid=session.getAttribute("uid").toString();
        String pid=request.getParameter("id");
        mm.Conn1 c1=new mm.Conn1();
        ResultSet rs=c1.executeQuery("select * from  booking where user_id='"+uid+"'");
        while(rs.next()){
            %>
         <tr><th><%=rs.getString("city")%></th><th><%=rs.getString("package_name")%></th><th><%=rs.getString("duration")%></th><th><%=rs.getString("total_person")%></th><th><%=rs.getString("price")%></th><th><%=rs.getString("total_price")%></th><th><%=rs.getString("status")%></th></tr>
