...
<html lang="en">
  ...
  <body>
    ...
    <div style="height:350%;" class='success'>
<html>
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <br><br>
    <center><h1>Explore Tour/Packages</h1></center><hr><br><br>
    <% String tid=request.getParameter("id");
    String city=request.getParameter("city");
    mm.Conn1 c1=new mm.Conn1();
    ResultSet rs=c1.executeQuery("select * from package where package_no='"+tid+"'");
    if(rs.next()){%>  
    <center> <table cellspacing='10' cellpadding='10'> <tr><td colspan="2">
                <h2><center><%=rs.getString("package_name")%></center></h2></td></tr>
        <tr><td colspan='2'><img src=images/<%=rs.getString("image")%> height='400' width='600'></td></tr>
        <tr><th>City</th><td><%=rs.getString("city_name")%></td></tr>
        <tr><th>Time Duration of Tour </th><td><%=rs.getString("duration")%></td></tr>
        
        <tr><th>Price Of Tour(per person)</th><td><%=rs.getString("price")%></td></tr>
        <tr><th colspan="2"><center><a href="book_tour.jsp?id=<%=rs.getString("package_no")%>">Book This Tour/Package</a></center></th>
        </table></center><br>
   <% }
    %> </body>
</html>
