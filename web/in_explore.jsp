...
<body>
    ...
    <div style="height:1500%;" class='success'>      
<%mm.Conn1 c1=new mm.Conn1();
   
    ResultSet rrs=c1.executeQuery("select * from package");
    if(rrs.next()){
...
<center><h1>ALL OFFERED TOUR/PACKAGES</h1></center><hr><br><br>

    <%
   
   mm.Conn1 c2=new mm.Conn1();
    ResultSet rs=c2.executeQuery("select * from cities ");
    while(rs.next()){
   String city=rs.getString("city_name");
%><center><h1>PACKAGES FOR <%out.print(city);%></h1></center>
 <div> <img src=images/<%=rs.getString("image")%> height="250" width="100%"> </div><br><br>
   
 
 
            <%mm.Conn1 c3=new mm.Conn1(); ResultSet r1=c3.executeQuery("select * from package where city_name='"+city+"' ");
            while(r1.next()){
            %><center><table cellspacing="10" cellpadding="10"> <tr><th><img src=images/<%=r1.getString("image")%> width="300" height="300"></th><td>PACKAGE DETAILS :<BR>Name :<%=r1.getString("package_name")%><br>Starting From : Rs. <%=r1.getString("price")%> (single person only)<br>
