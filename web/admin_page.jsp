...
<html>
    ...
    <body>
     <center><h1>Welcome Admin</h1></center><hr><br><br>
  
    <ul class="abc">
        <li><a href="add_city.jsp">ADD NEW CITY</a></li>
        <li><a href="add_place.jsp">ADD NEW PLACES</a></li>
        <li><a href="add_package.jsp">ADD NEW PACKAGE</a></li>
        <li><a href="edit_package.jsp">EDIT PACKAGES</a></li>
        <li><a href="new_guide.jsp">NEW GUIDE REQUESTS</a></li>
    </ul>
    </body>
</html>
</div>
