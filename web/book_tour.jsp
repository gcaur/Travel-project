...
<body>
     ...
     <form name="f1" action="book_tour1.jsp">
            <center><h1>Book Tour</h1></center>
    <hr>
      <% mm.Conn1 c1=new mm.Conn1();
      String package_no=request.getParameter("id");
ResultSet rs=c1.executeQuery("select * from package where package_no='"+package_no+"'");%><input type="hidden" name="id" value="<%=package_no%>"><table cellpadding="10"><tr>

     <%   if(rs.next()){%>
    <center> <table><tr><th>Package Name : </th>
        <td><input type="text" name="pname" value="<%=rs.getString("package_name")%>" readonly="readonly"></td></tr><tr><th>Package Price:(per person)</th><td><input type="text" name="price" value="<%=rs.getString("price")%>" readonly="readonly"></td></tr>
    <tr><th>Duration </th><td><input type="text" name="duration" value="<%=rs.getString("duration")%>" readonly="readonly"></td></tr>
    <tr><th>Select Starting Date : </th><td><input type="date" name="sdate"></td></tr>
    <tr><th>Select No. of Person : </th><td><input type="number" min="1" max="5" name="person">(min. 1 and max. 5 person)</td></tr>
    <tr><th colspan="2"> <input type="submit" value="BOOK NOW" ></th></tr>
                        </table></center>
         <input type="hidden" name="type" value="<%=rs.getString("type")%>">  
         <input type="hidden" name="city" value="<%=rs.getString("city_name")%>">
       <% }
