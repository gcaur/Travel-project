...
<form name="f1" action="change_password21.jsp" method="post">
    <center><table cellspacing="20"> <tr><td colspan="2"><center><h2>CHANGE PASSWORD</h2></center></td></tr>
            <tr><td>Enter Current Password</td><td><input type="password" name="cpass" placeholder="Enter Current Password" required='required'></td></tr>
    <tr><td>Enter New Password</td><td><input type="password" name="npass" placeholder="Enter New Password" required='required'></td></tr>
    <tr><td>Re-enter New Password</td><td><input type="password" name="npass1" placeholder="Re-Enter New Password" required='required'></td></tr>
