...
<html lang="en">
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <div class="col-md-12 margin-top-30">
                            <center><h2>Application Form for New Guides</h2></center><hr>
                            <form action="add_guide1.jsp" enctype="multipart/form-data" method="post">
    <table cellspacing="10"><tr><th>Enter Name </th><td><input type="text" name="name" required="required"></td></tr>
        <tr><th>Please Select City </th><td><select name="city" required="required">
    ...
    <%}%>
        ...
        <tr><th>Enter Contact Number</th><td><input type="text" name="mno" required="required"></td></tr>
        <tr><th>Enter E-mail ID</th><td><input type="email" name="email" required="required"></td></tr>
        <tr><th>Select Image </th><td><input type="file" name="image" required="required"></td></tr>
        <tr><td colspan="2"> <center><input type="submit" value="Apply"></center></td></tr></table>
                            </form>
                        </div>
                    </div>
                </div>
