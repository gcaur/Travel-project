...
//System.out.println(config.getServletContext().getRealPath("/"));
                    File savedFile = new File(config.getServletContext().getRealPath("/") + "../../web/users/" + image);
    ...
    try {
        ...
        int s1 = cn.executeUpdate("insert into users(admin_name,admin_pass,email,image) values('" + uname + "','" + pass + "','" + email + "','" + image + "')");
        if (s1 == 1) {
