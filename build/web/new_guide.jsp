                    ...
                    <div class="col-md-12 no-padding">
                        <div class="text-center visible-lg">
                            <ul id="hornavmenu" class="nav navbar-nav">
                                <li>
                                    <a href="admin_page.jsp" class="fa-home">Home</a>
                                </li>
...
<html>
    <body>
    <center><h1>NEW GUIDES REQUESTS</h1></center><hr><br><br><br>
    
    <center> <table cellspacing="10"><tr><th>Image</th><th>Guide Name</th><th>City</th><th>Contact Number</th><th>E-mail ID</th><th>Action</th></tr>
        <% mm.Conn1 c1=new mm.Conn1();
        
        ResultSet rs=c1.executeQuery("select * from guides where type='Unverified'");
        while(rs.next()){
            %>
        <tr><td><img src=guides/<%=rs.getString("image")%> height="100" width="100"></td><td><%=rs.getString("guide_name")%></td><td><%=rs.getString("city_name")%></td><td><%=rs.getString("contact_no")%></td><td><%=rs.getString("email")%></td><td><a href="new_guide1.jsp?gid=<%=rs.getString("guide_id")%>">Confirm</a></td></tr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 margin-bottom-20">
                            ...
                            <p>
                                ...
                                <a href="mailto:info@joomla51.com">pundirs0019@gmail.com</a>
                                <br>
