           ...
           <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        <div style="height:500%;" class='success'>
<html>
    <body>
    <center><h2>ALL TOUR AND PACKAGES</h2></center><hr>
        <br>
        <br>
        <center><table><tr><th>Tour Id</th><th>Tour Name</th><th>City</th><th>Price(per person)</th><th>Action</th></tr>
        <%     mm.Conn1 c1=new mm.Conn1();
           String city=request.getParameter("city");
           ResultSet r=c1.executeQuery("select * from package where city_name='"+city+"'");
           while(r.next()){
               %>
            <tr><td><%=r.getString("package_no")%></td><td><%=r.getString("package_name")%></td><td><%=r.getString("city_name")%></td><td><%=r.getString("price")%></td><td><a href="edit_package2.jsp?pid=<%=r.getString("package_no")%>">EDIT</a></td></tr>
             <%
           }
        %>
            </table></center>
