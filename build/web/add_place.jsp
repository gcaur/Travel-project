...
<html>
    <script type="text/javascript">
        function valid(){
            ...
            if(f1.place.value==null || f1.place.value==""){
                alert("Please enter place");
                return;
            }
            if(/[0-9]/.test(f1.place.value))
            {
        ...
        <body><form name="f1" action="add_place1.jsp">
                <center>    <div>  <h1>ADD NEW PLACE</h1></div></center><hr><br><br>
                <div> <center> PLEASE SELECT CITY : <select name="city" required="required">
                ...
                %>
                        ...
                        ENTER NEW PLACE : <input type="text" name="place" placeholder="Enter Place name">
                <br><br>
